...
//  const[requested,setrequested]=useState('');console.log('requestedto',requested);
  ...
  const getAllUsers=()=>{
    ...
    fetch(IP.IP+"User/getAllUsers?pageNo=1&cnic="+global?.user?.CNIC, requestOptions)
