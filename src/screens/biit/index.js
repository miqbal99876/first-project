    ...
    <View style={styles.container}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => {
          ...
          //   const user = typeof item?.post?.user === 'string'
          //   ?item?.post?.user 
            ...
            <View
              ...
              <Row
                ...
                <Row style={{ alignItems: 'center' }}>
                  ...
                  <Text style={{ color: colors.black, marginLeft: 10 }}>{item?.post?.user}</Text>
                </Row>
                <Row style={{ alignItems: 'center' }}>
                  <Text style={{ color: colors.black }}>{item?.post?.dateTime}</Text>
